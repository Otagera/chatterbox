...
export class ChatterboxSDK {
    ...
    /**
     * Method for processing queued logs
     * @private
     ...
     * @returns {Promise<void>}
     */
    queueLog: (logData: any) => Promise<void>;
    /**
...
export function startChatterboxServer(options: any): net.Server;
